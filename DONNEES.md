...
- **Aucun historique de déplacement.** Une sortie passée est effacée, pas archivée. Il
  ...
  le mois dernier — y compris sous forme de statistique.
...
- **Sur vos enfants, rien d'autre qu'un prénom.** Pas de nom de famille, **pas d'âge ni de
  date de naissance**, pas de photo, pas de genre, pas d'école, pas de classe, pas de santé.
  Les membres d'un cercle connaissent déjà les enfants dont il est question : l'app n'a rien
  à ajouter. Le champ « année de naissance » a existé pendant la conception, puis a été
  supprimé faute d'un usage qui le justifie.
...
- Les **notifications** suivent exactement la même règle : vous ne pouvez pas être averti·e de
  ...
  dit ni qui, ni où — seulement le nom du cercle — pour qu'un écran verrouillé posé sur une
  table ne raconte rien.

Cette règle est écrite à un seul endroit du code, et vérifiée par une série de tests qui
énumèrent les cas un par un. Ce n'est pas une promesse : c'est une démonstration, qui peut
être montrée sur demande.
...
- les pages de ces sites qui ne publient pas d'agenda structuré sont lues par un service
  ...
  sont envoyées** — jamais une donnée vous concernant.
