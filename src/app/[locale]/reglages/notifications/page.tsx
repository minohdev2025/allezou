...
import { Bouton, Carte, Champ, Pastille } from "../../ui";
 ...
 *
 * Les trois cartes agenda (mots-clés, alerte sur inscription, rappel de
 * présence) vivent ici aussi : c'est l'endroit où l'on décide de quoi on
 * est prévenu, et c'est ce que cette page active. La page /reglages/agenda
 * garde le même contenu pour l'instant — elle sera supprimée le jour où
 * l'on sera sûr que tout le monde arrive ici.
 */
