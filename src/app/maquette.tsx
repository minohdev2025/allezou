...
export function MaquetteSortie({ className = "" }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 360 152"
      role="img"
      aria-label="Exemple d'écran : Sophie est au parc du Gué avec Léa et Matéo, jusqu'à 17h. Deux autres familles sont avec eux, et un bouton « Nous aussi » permet de les rejoindre."
