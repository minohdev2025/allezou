...
const REGLES_FIDELITE = [
  ...
  "- Une activité qui se répète sur une période garde la date du premier jour dans « debut ».",
  "  Son rythme va dans « recurrence », recopié mot pour mot (« les mercredis », « chaque",
  "  samedi », « du lundi au vendredi »). Ne découpe pas une activité répétée en plusieurs",
  "  événements, et n'invente jamais les dates de ses occurrences.",
  "- « fin » ne se remplit que si la page écrit quand l'activité s'arrête. Un marché ou un",
  "  cours annoncé sans terme n'a pas de fin à lire : omets le champ. Une fin qui n'est pas",
  "  sur la page est une date inventée comme une autre.",
